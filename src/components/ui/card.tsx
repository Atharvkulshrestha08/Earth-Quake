...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant = "default", severity, children, ...props }, ref) => {
    const variantStyles = {
      ...
      alert: severity && severity >= 4 ? "bg-alert-high/5 border-alert-high animate-pulse-slow" : "bg-neutral-800 border-neutral-700",
      shelter: "bg-neutral-800 border-neutral-700",
    };
