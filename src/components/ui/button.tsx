  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        destructive: "bg-alert-high text-white hover:bg-alert-critical shadow-lg shadow-alert-high/25",
        outline: "border-2 border-primary-500 bg-transparent text-primary-500 hover:bg-primary-500 hover:text-white",
        secondary: "bg-neutral-200 text-neutral-900 hover:bg-neutral-300",
        ghost: "hover:bg-neutral-100 text-neutral-200 hover:text-white",
        link: "text-primary-500 underline-offset-4 hover:underline",
        success: "bg-alert-low text-white hover:bg-green-600 shadow-lg shadow-alert-low/25",
      },
      size: {
